    ...
    if(isset($_POST['simpan'])){
        ...
        if(!empty($nama_photo)){
            if(!in_array($ekstensi, $tipe_array)){
                ...
                $qt = mysqli_query($con,"INSERT INTO tb_news(judul,description,permalink,gambar,created,id_login) VALUES ('$judul','$deskripsi','$permalink','$nama_file',now(),'$users')");
            ...
            <div class="card">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="card-body card-block">
                        <div class="has-success form-group"><label class=" form-control-label">Judul</label><input type="text" name="judul" class="is-valid form-control-succes form-control"></div>
